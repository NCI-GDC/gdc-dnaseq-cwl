...
steps:
  ...
  - id: gatk_collectmultiplemetrics_to_sqlite
    ...
    in:
      ...
      - id: vcf
        ...
        valueFrom: $(self.basename)
      - id: alignment_summary_metrics
        source: gatk_collectmultiplemetrics/alignment_summary_metrics
      - id: bait_bias_detail_metrics
        source: gatk_collectmultiplemetrics/bait_bias_detail_metrics
      - id: bait_bias_summary_metrics
        source: gatk_collectmultiplemetrics/bait_bias_summary_metrics
      - id: base_distribution_by_cycle_metrics
        source: gatk_collectmultiplemetrics/base_distribution_by_cycle_metrics
      - id: gc_bias_detail_metrics
        source: gatk_collectmultiplemetrics/gc_bias_detail_metrics
      - id: gc_bias_summary_metrics
        source: gatk_collectmultiplemetrics/gc_bias_summary_metrics
      - id: insert_size_metrics
        source: gatk_collectmultiplemetrics/insert_size_metrics
      - id: pre_adapter_detail_metrics
        source: gatk_collectmultiplemetrics/pre_adapter_detail_metrics
      - id: pre_adapter_summary_metrics
        source: gatk_collectmultiplemetrics/pre_adapter_summary_metrics
      - id: quality_by_cycle_metrics
        source: gatk_collectmultiplemetrics/quality_by_cycle_metrics
      - id: quality_distribution_metrics
        source: gatk_collectmultiplemetrics/quality_distribution_metrics
      - id: quality_yield_metrics
        source: gatk_collectmultiplemetrics/quality_yield_metrics
    out:
      - id: log
      - id: sqlite
